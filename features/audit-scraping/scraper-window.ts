 ...
 */
import { sendTabMessage, type ExtensionMessage } from "@/lib/browser/messages";
...
export interface CreateScraperTabOptions {
  ...
  messageOnLoad?: ExtensionMessage; // optional message to send when page loads
}
...
export async function createScraperTab(
  ...
  return new Promise((resolve, reject) => {
    ...
    const handleTabComplete = () => {
      ...
      if (messageOnLoad) {
        sendTabMessage(tabId, messageOnLoad)
          .then(() => {
