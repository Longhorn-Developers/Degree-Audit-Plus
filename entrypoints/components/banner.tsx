...
const TryDAPBanner = () => {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
          className="bg-dap-primary relative w-full p-4 flex justify-start items-center gap-6 flex-row text-white shadow-lg shadow-black/20 rounded-md overflow-hidden"
        ...
        >
          ...
          <button className="flex items-center gap-2 text-black absolute right-4 bottom-4 bg-white rounded-lg px-2 py-1 cursor-pointer border-none outline-none shadow-none transition-all duration-300 ease-in-out transform scale-100 origin-center z-10">
